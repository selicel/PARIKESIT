...
@section('content')
    <div class="card mt-6 p-8">
        ...
        <form action="{{ route('formulir.update', $formulir) }}" method="POST">
            @method('PUT')
            @csrf
            ...
            <div class="flex flex-col gap">
                ...
                <input type="text"
                    ...
                    name="nama_formulir" value="{{ $formulir->nama_formulir }}" required>
            ...
            <a href="{{route('formulir.index')}}" class="mt-5 p-2 px-8 bg-gray-600 text-white hover:bg-blue-900 hover:text-white ease-in-out transition duration-100 border rounded-md"> Kembali</a>
            </div>
