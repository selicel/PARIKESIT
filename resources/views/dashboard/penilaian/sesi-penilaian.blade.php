    ...
    <div class="p-6 bg-white shadow rounded-md space-y-6">
                ...
                <form
                    ...
                    <div
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <label for="level3_update" class="{{ $style }}">
                                <div class="flex items-start space-x-3">
                            ...
                            <label for="level4_update" class="{{ $style }}">
                                <div class="flex items-start space-x-3">
                            ...
                            <label for="level5_update" class="{{ $style }}">
                                <div class="flex items-start space-x-3">
        ...
        <form action="{{ route('formulir.store-penilaian', [$formulir, $domain, $aspek, $indikator]) }}" method="POST"
            ...
            <div class="mt-5">
                ...
                @if ($dinilai)
                    @php
                        $buktiDukungFiles = $dinilai->bukti_dukung != '-'
                            ? json_decode($dinilai->bukti_dukung)
                            : [];
                    @endphp
